...
@section('content')
    <div class="p-3 border-0 shadow-sm card rounded-4 position-relative" style="max-width: 400px; margin: auto;">
        <a href="{{ route('profile#edit', auth()->user()->id) }}" class="btn btn-sm btn-outline-secondary position-absolute"
