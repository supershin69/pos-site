                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-8 text-end">
                        <ul class="mb-5 text-center nav nav-pills d-inline-flex">
                            <li class="nav-item">
                                <a class="py-2 m-2 d-flex bg-light rounded-pill " href="">
                                        ...
                                        <div class="rounded position-relative fruite-item">
                                            ...
                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                ...
                                                <div class="d-flex justify-content-between flex-lg-wrap">
                                                    <p class="mb-0 text-dark fs-5 fw-bold"> mmk</p>
                                                    <a href="#"
                            ...
                            <div class="col-lg-12">
                                <div class="row g-4">
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="rounded position-relative fruite-item">
                                            <div class="fruite-img">
                                                <img src="{{ asset('user_template/img/fruite-item-5.jpg') }}" class="img-fluid w-100 rounded-top"
                                                    alt="">
                                            </div>
                                            <div class="px-3 py-1 text-white rounded bg-secondary position-absolute"
